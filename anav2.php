...
<div class="w3-bar" style="color:white; background-color:#62A8C8; padding-left:10px; font-family:roboto">
   ...
   <a href="fee1.php"> <button class="w3-btn" style="background-color:#62A8C8; color:white">HOME</button></a>
    
    </div>
    
    <div class="w3-dropdown-hover">
    <a href="sdashboard.php"><button class="w3-btn" style="background-color:#62A8C8; color:white">DASHBOARD</button></a>
    
    </div>
    <div class="w3-dropdown-hover">
    <a href="studentstep2.php"><button class="w3-btn" style="background-color:#62A8C8; color:white">CREATE PROFILE</button></a>
