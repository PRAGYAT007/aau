...
<form action="saveformgenerate.php" method="post"  >
...
$sql=mysqli_query($con,"select * from courses where courseid=102");
...
<br><br>
<select class="w3-input" style="border:1px solid gray;" name="bpl" required="">
<option selected disabled value="">--Choose B.P.L Category--</option>
<option>BPL</option>
<option>NON-BPL</option>
</select><br><br>
<select class="w3-input" style="border:1px solid gray;" name="dable" required="">
<option selected disabled value="">--Select Yes If Differently Abled--</option>
<option>YES </option>
<option>NO</option>
</select>
<br><br><br>

<label> <span style="color:red; font-size:13px;">(*Last Examination cleared/ appeared.)</span></label><br><br>
<input type="hidden"  name="code1" id="code1" >
<input type="text" class="w3-input" style="border:1px solid gray;" placeholder="Last examination cleared / appeared" name="lexam" required=""><br><br>
<input type="float" class="w3-input" style="border:1px solid gray;" placeholder="Last examination percentage (enter numeric value) " min="0" name="lpercent" required="">
<br><br>
