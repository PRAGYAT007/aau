...
<p class="w3-text-red"> * The Password Will Be send to the registered phone number with the above email id</p>
...
<br>
<center>
<input type="submit" style="background:#999; width:30%; padding:2%; border-radius:5px; " class="w3-btn w3-medium w3-text-white w3-green" value="Send message" id="send"  name="submit" onclick="return confirm('Do you really want to send the message?');">
