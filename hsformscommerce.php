...
<head>
<meta charset="utf-8">
<title>H.S Forms Commerce</title>
...
<div id="main" style="margin-left:230px;">
    ...
    <span style="; font-family:roboto; font-size:25px; color:slategray;">   
        <div class="w3-container w3-padding w3-card" style="background-color:white">&nbsp;<i class="fa fa-list"></i> &nbsp;Higher Secondary
 ...
 <table class="w3-table-all w3-card-2" style="overflow:scroll">
    ...
    <?php
	include 'connect.php';
	$result=mysqli_query($con,"select * from  formgenerate where coursecode = 101 payment='PAID' and merit='NOTSELECTED' order by lpercent desc");
